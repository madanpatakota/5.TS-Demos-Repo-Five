 ...
 *
*/
var customerDetails_1 = [1, "John", 1200.09, "London"]; //Note : make it proper reference variable name
...
var customerDetails_3 = [1, "John", 1200.09, "London"]; //Note : make it proper reference variable name
 ...
 *
*/
var customerDetails_4 = [1, "John", 1200.09, "London"]; //Note : make it proper reference variable name
